 ...
 */
public class ListeningLong2ObjectOpenHashMapPaperMC<V> extends Long2ObjectOpenHashMap<V> {
    private final Callback<V> addCallback, removeCallback;

    public ListeningLong2ObjectOpenHashMapPaperMC(Callback<V> addCallback, Callback<V> removeCallback) {
